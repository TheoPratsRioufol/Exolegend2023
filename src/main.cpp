...
void go_to(Position cons, Position pos)
{
    ...
    gladiator->control->setWheelSpeed(WheelAxis::RIGHT, 0, false); // GFA 3.2.1
    gladiator->control->setWheelSpeed(WheelAxis::LEFT, 0, false);  // GFA 3.2.1
}
...
void loop()
{
    ...
    { // tester si un match à déjà commencer
        ...
        // gladiator->control->setWheelSpeed(WheelAxis::RIGHT, 0.1, false);
        // gladiator->control->setWheelSpeed(WheelAxis::LEFT, 0.2, false);
        // delay(1000);
